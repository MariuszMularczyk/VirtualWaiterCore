<template>
    ...
    <div id="example" width="1500">
        ...
        <div class="center examplex">
            <vs-navbar square center-collapsed v-model="active">
                ...
                <template #right>
                    ...
                    <vs-button style="font-size: 1.00rem;" color="rgb(59,222,200)" gradient @click="goToCart()">
                        Zamówienie <div style="font-size: large; margin-right: 10px;">
        ...
        <div class="text-center" style=" position: fixed; bottom: 0; right:0; text-align: center"
            ...
            <div><a href="https://www.freelogodesign.org" title="freelogodesign">www.freelogodesign.org</a> <a href="https://www.freeimages.com/pl" title="freeimages"> www.freeimages.com</a></div>
            <div></div>
        </div>
    </div>
